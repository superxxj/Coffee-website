...
<title>Coffee type list page</title>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">Coffee type display</span><span class="ng-inmod-the-en" aos="fade-up">DATA data SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              ...
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('kafeileixing','add')" @click="jump('../kafeileixing/add.jsp')" type="button" class="layui-btn btn-theme">
    ...
    <div class="am-end">
      ...
      <div class="am-end-ini">
        <div class="ng-siotext" aos="fade-up" aos-delay="400" aos-anchor-placement="top-bottom">
          <p>welcome access coffee website</p>
        </div>
      </div>
      </div>
    </div>
