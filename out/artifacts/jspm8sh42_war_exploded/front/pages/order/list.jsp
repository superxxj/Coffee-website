	...
	<body style="background: #EEEEEE;">
		...
		<div id="app">
			...
			<div class="line-container">
				<p class="line" style="background: #EEEEEE;"> my order </p>
			</div>
			<!-- 标题 -->
				...
				<div class="right-container" style="padding-top: 0;">
					<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
						<ul class="layui-tab-title">
							<li @click="pageList('未支付')" class="layui-this">non-payment</li>
							<li @click="pageList('已支付')">have paid</li>
							<li @click="pageList('已发货')">shipped</li>
							<li @click="pageList('已完成')">off the stocks</li>
							<li @click="pageList('已退款')">refunded</li>
							<li @click="pageList('已取消')">canceled (canc)</li>
						</ul>
									...
									<tr v-for="(item,index) in dataList" v-bind:key="index">
										...
										<td style="width: 100px;">
											...
											<button v-if="item.status=='已发货'" @click="confirm(item)" type="button" class="layui-btn layui-btn-sm layui-btn-radius layui-bg-green">
												<i class="layui-icon">&#xe65e;</i> confirm receipt
											</button>
										</td>
									</tr>
								</tbody>
