...
<title>Coffee information list page</title>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">Coffee information display</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">coffeename</label>
                <div class="layui-input-inline">
                  <input type="text" name="kafeimingcheng" id="kafeimingcheng" placeholder="coffeename" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">Type of coffee</label>
                <div class="layui-input-inline">
                  <input type="text" name="kafeileixing" id="kafeileixing" placeholder="Type of coffee" autocomplete="off" class="layui-input">
                </div>
              </div>   
