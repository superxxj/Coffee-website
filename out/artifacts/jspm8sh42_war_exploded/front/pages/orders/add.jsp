		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<label class="layui-form-label">order number：</label>
						...
						<div class="layui-input-block">
							<input v-model="detail.goodname" type="text" name="goodname" id="goodname" autocomplete="off" class="layui-input">
                                                                                ...
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">product image：</label>
						...
						<div class="layui-input-block">
							<button type="button" class="layui-btn btn-theme" id="pictureUpload">
								<i class="layui-icon">&#xe67c;</i>Upload product pictures
							</button>
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
					...
					<div class="layui-form-item">
						<div class="layui-input-block" style="text-align: right;margin-right: 30px;">
							<button class="layui-btn btn-submit" lay-submit lay-filter="*">submit</button>
