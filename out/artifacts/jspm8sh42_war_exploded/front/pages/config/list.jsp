...
<title>The rotation chart Management list page</title>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">Show the management of wheel casting chart</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
