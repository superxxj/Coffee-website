        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">Customer Display</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">client number</label>
                <div class="layui-input-inline">
                  <input type="text" name="kehuhao" id="kehuhao" placeholder="client number" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">customer name</label>
                <div class="layui-input-inline">
                  <input type="text" name="kehuxingming" id="kehuxingming" placeholder="customer name" autocomplete="off" class="layui-input">
                </div>
              </div>   
    ...
    <div class="am-end">
      ...
      <div class="am-end-ini">
        <div class="ng-siotext" aos="fade-up" aos-delay="400" aos-anchor-placement="top-bottom">
          <p>welcome<span v-text="projectName"></span>！</p>
        </div>
      </div>
      </div>
    </div>
