//  菜单显示异常edit tinymce/skins/ui/oxide/skin.min.css:96 .tox-silver-sink的z-index值
...
layui.define(['jquery'],function (exports) {
    ...
    var settings = {
        base_url: modPath
        , images_upload_url: '/rest/upload'//图片上传接口，可在option传入，也可在这里edit ，option的值优先
        , language: 'zh_CN'//语言，可在option传入，也可在这里edit ，option的值优先
        , response: {//后台返回数据格式设置
        ...
        , success: function (res, succFun, failFun) {//图片上传完成回调 根据自己需要edit 
