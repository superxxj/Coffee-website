 ...
 * @param {String|Function} deleteFileCallback delete 文件的回调
...
baidu.flash.fileUploader = baidu.flash.fileUploader || function(options){
     ...
     * delete 文件
     * @public
     * @param {Number|Array} [index] 要delete 的index，不传则全部delete 
...
/**
 * delete script的属性，再delete script标签，以解决修复内存泄漏的问题
 * 
 * @param {HTMLElement} src script节点
 */
