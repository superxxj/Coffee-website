				...
				<div class="row breadcrumb-bar">
					...
					<div class="col-md-6">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><span>edit password</span></li>
							<li class="breadcrumb-item active"><span>edit password</span></li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">edit password</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>old password</label> <input id="oldPassword" name="oldPassword"
											class="form-control" placeholder="old password">
									</div>

									<div class="form-group col-md-6">
										<label>new password</label> <input id="newPassword" name="newPassword"
											class="form-control" placeholder="new password">
									</div>

									<div class="form-group col-md-6">
										<label>check password</label> <input id="confirmPassword"
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
				...
				if(password == $('#oldPassword').val()){
					httpJson(accountTableName + "/update","POST",{
						...
						if(res.code == 0){
							...
							alert('Successfully modified, please log in again');
						}						
					});
				}else{
					alert('Original password input error')
				}
			} else {
				alert("Incomplete or incorrect form");
			}
		}
		...
		function validform() {
			return $("#addOrUpdateForm").validate({
				...
				messages : {
					oldPassword : {
						required : "The original password cannot be empty",
					},
					newPassword : {
