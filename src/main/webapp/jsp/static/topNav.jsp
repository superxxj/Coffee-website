				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">cafe management system</a>
						</div>
							...
							<li class="nav-item" style="position: relative;">
								...
								<div class="dropdown-menu lochana-box-shadow2 profile animated flipInY">
									...
									<a class="dropdown-item web" href="#" onclick="toFront()">
										<span class="ti-power-off"></span><span class="text">Jump to the foreground</span></a>
									<a class="dropdown-item exit" href="#" onclick="logout()">
										<span class="ti-power-off"></span><span class="text">Log out</span></a>
								</div>
							</li>
						</ul>
