		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">Coffee Type Management</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>Coffee Type Management</span></li>
								<li class="breadcrumb-item active"><span>Coffee Typelist</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">Coffee Typelist</h3>
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<button onclick="deleteMore()" type="button" class="btn btn-danger delete ">批量delete </button>
								</div>
