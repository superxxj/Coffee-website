...
<body>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow min-h200" style="height: 700px;">
							...
							<h1 align="center" style="margin-top: 250px;"><strong>Welcome coffee website</strong></h1>
						</div>
					</div>
				</div>
			</div>
	...
	<script>
		...
		if(window.localStorage.getItem("Token") != null && window.localStorage.getItem("Token") != 'null'){
		  ...
		  $('h1 strong').html('Welcome to'+projectName)
		  $('.dropdown-menu h5').html(window.sessionStorage.getItem('username'))
		  $('.sidebar-header h3 a').html(projectName)
		  var token = window.sessionStorage.getItem("token");
		  if(token == "null" || token == null){
		  	alert("Please log in and try again operation");
