...
(function( root, factory ) {
    ...
    define('uploader',[
        ...
        $.extend( Uploader.prototype, {
             ...
             * * `successNum` 上传success的文件数
             * * `uploadFailNum` 上传失败的文件数
             * * `cancelNum` 被delete 的文件数
             * * `invalidNum` 无效的文件数
             * * `queueNum` 还在队列中的文件数
             * @method getStats
    ...
    define('queue',[
        ...
        $.extend( Queue.prototype, {
            ...
            /**
             * 获取指定类型的文件list, list中每一个成员为[File](#WebUploader:File)对象。
    ...
    define('widgets/upload',[
        ...
        Uploader.register({
             ...
             * @param {File} [file] File对象
             * @description 不管success或者失败，文件上传完成时触发。
             * @for  Uploader
             */
    ...
    define('widgets/validator',[
         ...
         * @namespace options
         * @for Uploader
         * @description 去重， 根据文件名字、文件大小和最后edit 时间来生成hash Key.
         */
    ...
    define('runtime/html5/dnd',[
        ...
        return Html5Runtime.register( 'DragAndDrop', {
            ...
            // 如果传入 callback 则去find文件夹，否则只管当前文件夹。
     ...
     * @fileOverview Transport
     * @todo 支持chunked传输，优势：
     * 可以将大文件分成小块，挨个传输，可以提高大文件success率，当失败的时候，也只需要重传那小部分，
