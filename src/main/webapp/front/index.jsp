            ...
            <div class="am-pc-nav am-ipad-hide" aos="fade-left" style="z-index: 1000;">
                <ul>
                    <li class='ng-nav-activate'>
                        <a href="javascript:navPage('./pages/home/home.jsp')" class="am-pclink">Index</a>
                        <span class="am-pclink-borv"><span></span></span>
                    </li>
                    <li class='' v-for="(item,index) in indexNav" v-bind:key="index">
                        <a :href="'javascript:navPage(\''+item.url+'\')'" class="am-pclink">Coffee information</a>
                        <span class="am-pclink-borv"><span></span></span>
                    </li>

                    <li class=''>
                        <a target="_blank" :href="adminurl" class="am-pclink">Background</a>
                        <span class="am-pclink-borv"><span></span></span>
                    </li>
                    <li class='' v-if="cartFlag">
                        <a href="javascript:navPage('./pages/cart/list.jsp')" class="am-pclink">
                            <i class="layui-icon" style="font-size: 30px;">&#xe657;</i> Shopping Cart
                        </a>
                        <span class="am-pclink-borv"><span></span></span>
                    </li>
