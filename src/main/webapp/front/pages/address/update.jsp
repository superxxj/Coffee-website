	...
	<body style="background: #EEEEEE;">
		...
		<div id="app">
			...
			<div class="line-container">
				<p class="line" style="background: #EEEEEE;"> Shipping address added </p>
			</div>
			<!-- 标题 -->
				...
				<div class="right-container" style="padding-top: 0;">
					<form style="margin-top: 20px;" class="layui-form" lay-filter="myForm">
						<div class="layui-form-item layui-form-text">
							<label class="layui-form-label">contacts</label>
							<div class="layui-input-block">
								<input type="text" name="name" id="name" required lay-verify="required" placeholder="contacts" autocomplete="off"
								 class="layui-input">
							</div>
						</div>
						<div class="layui-form-item layui-form-text">
							...
							<div class="layui-input-block">
								<input type="text" name="phone" id="phone" required lay-verify="required|phone" placeholder="cell phone number" autocomplete="off"
								 class="layui-input">
							</div>
						</div>
						<div class="layui-form-item layui-form-text">
							<label class="layui-form-label">default address：</label>
							<div class="layui-input-block" style="width: 300px;text-align: left;">
								<input type="radio" name="isdefault" value="yes" title="yes" checked>
								<input type="radio" name="isdefault" value="no" title="no">
							</div>
						</div>
						<div class="layui-form-item layui-form-text">
							<label class="layui-form-label">select address：</label>
							<div class="layui-input-block">
								<input type="text" name="address" id="address" required lay-verify="required" placeholder="select address" autocomplete="off"
								 class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block" style="text-align: right;margin-right: 30px;">
								<button class="layui-btn btn-submit" lay-submit lay-filter="*">modification</button>
