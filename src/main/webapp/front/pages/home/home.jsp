        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">Coffee information recommendation</span>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">Coffee information display</span>
                ...
                <div class="ng-incontlst-col" v-for="(item,index) in kafeixinxiList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    ...
                    <div class="ng-fault ng-container">
                      ...
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../kafeixinxi/detail.jsp?id='+item.id)">view details</a>
                    </div>
                  </div>
                </div>
              </div>
