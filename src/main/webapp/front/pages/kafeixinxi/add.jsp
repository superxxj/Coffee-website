				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<button type="button" class="layui-btn btn-theme" id="tupianUpload">
								<i class="layui-icon">&#xe67c;</i>upload picture
                                                                                ...
                                                                                <div class="layui-form-item" pane>
                        <label class="layui-form-label">coffee type</label>
                        <div class="layui-input-block">
                            <select name="kafeileixing" id="kafeileixing" lay-filter="kafeileixing">
                                ...
                                <option v-for="(item,index) in kafeileixing" v-bind:key="index" :value="item">{{item}}</option>
                                                                                ...
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">loaction：</label>
						<div class="layui-input-block">
						...
						<div class="layui-input-block">
							<input v-model="detail.jiage" type="text" name="jiage" id="jiage" autocomplete="off" class="layui-input">
                                                                                                                                            ...
                                                                                                                                            <div class="layui-form-item" pane>
						<label class="layui-form-label">recently time：</label>
						<div class="layui-input-block">
							<input type="text" name="clicktime" id="clicktime" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">click number：</label>
						<div class="layui-input-block">
