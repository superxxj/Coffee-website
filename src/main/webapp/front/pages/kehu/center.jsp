	...
	<body style="background: #EEEEEE;">
		...
		<div id="app">
			...
			<div class="line-container">
				<p class="line" style="background: #EEEEEE;"> person centre </p>
			</div>
			<!-- 标题 -->
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="mima" id="mima"  autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">customer name</label>
							<div class="layui-input-block">
								<input type="text" name="kehuxingming" id="kehuxingming"  autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
							...
							<div class="layui-input-block">
								<input type="text" name="shoujihaoma" id="shoujihaoma"  autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">email</label>
							<div class="layui-input-block">
								<input type="text" name="youxiang" id="youxiang"  autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">balance</label>
							<div class="layui-input-inline">
								<input type="number" name="money" id="money" autocomplete="off" class="layui-input" disabled="disabled">
							</div>
