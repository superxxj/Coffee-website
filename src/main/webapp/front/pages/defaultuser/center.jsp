				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="username" id="username" placeholder="user name" autocomplete="off" class="layui-input"
								 disabled="disabled">
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="number" name="money" id="money" placeholder="balance" autocomplete="off" class="layui-input" disabled="disabled">
							</div>
							<div class="layui-form-mid layui-word-aux">
								<i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
								<a id="btn-recharge" href="javascript:void(0)">Recharge me</a>
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">integral</label>
							<div class="layui-input-block">
								<input type="number" name="jifen" id="jifen" placeholder="integral" autocomplete="off" class="layui-input" disabled="disabled">
							</div>
							<!-- <div class="layui-form-mid lntegralayui-word-aux">
								<i class="layui-icon" style="font-size: 20px;color: red;">&#xe64c;</i>  
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="number" name="age" id="age" lay-verify="age" placeholder="age" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label"> phone</label>
							<div class="layui-input-block">
								<input type="text" name="phone" id="phone" lay-verify="phone" placeholder=" phone" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">mailbox</label>
							<div class="layui-input-block">
								<input type="text" name="email" id="email" lay-verify="email" placeholder="mailbox" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
