	...
	<body>
		...
		<div id="app">
			...
			<div class="line-container">
				<p class="line"> confirm the order </p>
			</div>
			<!-- 标题 -->

			<div class="container">
				<h2 v-if="seat!=1">Select the shipping address</h2>
				...
				<table class="layui-table" lay-skin="nob" style="border: 3px dotted #EEEEEE;margin: 20px 0;">
					...
					<tbody>
						<tr v-for="(item,index) in dataList" v-bind:key="index">
							...
							<td v-if="type==2" style="width: 100px;">{{item.price}} integral</td>
							...
							<td v-if="type==2" style="width: 100px;">{{item.price*item.buynumber}} integral</td>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					// 正常下单，生成订单，减少余额，添加积分，减少库存，修改状态已payment
					payClick() {
