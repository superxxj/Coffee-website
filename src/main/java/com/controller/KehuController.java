...
public class KehuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		KehuEntity user = kehuService.selectOne(new EntityWrapper<KehuEntity>().eq("kehuhao", username));
    ...
    public R register(@RequestBody KehuEntity kehu){
    	...
    	KehuEntity user = kehuService.selectOne(new EntityWrapper<KehuEntity>().eq("kehuhao", kehu.getKehuhao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,KehuEntity kehu, HttpServletRequest request){
